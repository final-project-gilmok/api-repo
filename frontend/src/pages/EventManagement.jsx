...
/**
 * Render the event management page used to list existing demo events and create new ones.
 *
 * Renders a two-column layout: an events table with status badges and detail links, and a form to create a new event (requires a name). New events are appended with an autogenerated `EVTxxx` id and `draft` status.
 * @returns {JSX.Element} The React element for the Event Management page.
 */
